...
import { Users, Phone, Mail, MapPin, Star, Award, Calendar, Clock, CheckCircle } from 'lucide-react';

export default function VolunteerListPage() {
  const [volunteers] = useState([
    { id: 1, name: 'Amit Sharma', role: 'Medical Response', phone: '+91 98765 43210', email: 'amit@example.com', location: 'Downtown', status: 'available', skills: ['First Aid', 'CPR', 'Emergency Medicine'], joined: '2025-01-15', hours: 120, rating: 4.8, assignments: 5 },
    { id: 2, name: 'Priya Patel', role: 'Rescue Operations', phone: '+91 98765 43211', email: 'priya@example.com', location: 'North District', status: 'available', skills: ['Search & Rescue', 'Swimming', 'Climbing'], joined: '2025-02-10', hours: 85, rating: 4.9, assignments: 3 },
    { id: 3, name: 'Rajesh Kumar', role: 'Logistics', phone: '+91 98765 43212', email: 'rajesh@example.com', location: 'East District', status: 'assigned', skills: ['Supply Chain', 'Transportation', 'Inventory'], joined: '2024-11-20', hours: 200, rating: 4.7, assignments: 8 },
    { id: 4, name: 'Sunita Reddy', role: 'Communications', phone: '+91 98765 43213', email: 'sunita@example.com', location: 'Command Center', status: 'available', skills: ['Radio Operations', 'Data Analysis', 'Public Relations'], joined: '2025-01-05', hours: 95, rating: 4.9, assignments: 4 },
    { id: 5, name: 'Vikram Singh', role: 'Medical Response', phone: '+91 98765 43214', email: 'vikram@example.com', location: 'South District', status: 'assigned', skills: ['First Aid', 'Trauma Care', 'Patient Transport'], joined: '2024-12-01', hours: 150, rating: 4.8, assignments: 6 },
    { id: 6, name: 'Neha Gupta', role: 'Rescue Operations', phone: '+91 98765 43215', email: 'neha@example.com', location: 'West District', status: 'available', skills: ['Water Rescue', 'First Aid', 'Navigation'], joined: '2025-03-01', hours: 45, rating: 4.7, assignments: 2 },
  ]);
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white">Volunteer List</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {volunteers.map(volunteer => (
          <div key={volunteer.id} className="bg-white/5 rounded-xl p-4 hover:bg-white/10 transition-colors">
            ...
            <div className="mt-2 text-xs text-gray-500">Assignments: {volunteer.assignments}</div>
          </div>
        ))}
      </div>
    </div>
