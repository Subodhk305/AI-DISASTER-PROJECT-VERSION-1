...
import { Users, Phone, Mail, MapPin, Star, CheckCircle, Clock, AlertCircle } from 'lucide-react';

export default function PersonnelPage() {
  const [staff] = useState([
    { id: 1, name: 'Dr. Sarah Johnson', role: 'Medical Director', department: 'Medical', phone: '+91 98765 43210', email: 'sarah@disasterai.com', location: 'Central Hospital', status: 'available', skills: ['Emergency Medicine', 'Triage'], rating: 4.8 },
    { id: 2, name: 'Capt. Michael Chen', role: 'Rescue Team Lead', department: 'Rescue', phone: '+91 98765 43211', email: 'michael@disasterai.com', location: 'North Base', status: 'on-duty', skills: ['Search & Rescue', 'First Aid'], rating: 4.9 },
    { id: 3, name: 'Lisa Rodriguez', role: 'Logistics Coordinator', department: 'Logistics', phone: '+91 98765 43212', email: 'lisa@disasterai.com', location: 'Central Warehouse', status: 'available', skills: ['Supply Chain', 'Transportation'], rating: 4.7 },
    { id: 4, name: 'Dr. Amit Patel', role: 'Emergency Physician', department: 'Medical', phone: '+91 98765 43213', email: 'amit@disasterai.com', location: 'Field Hospital', status: 'on-duty', skills: ['Trauma Care', 'Emergency Medicine'], rating: 4.9 },
    { id: 5, name: 'James Wilson', role: 'Communications Officer', department: 'Communications', phone: '+91 98765 43214', email: 'james@disasterai.com', location: 'Command Center', status: 'available', skills: ['Radio Operations', 'Data Analysis'], rating: 4.6 },
  ]);
